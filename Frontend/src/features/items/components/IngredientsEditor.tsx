 ...
 * The detail page renders the same JSON back as readable lines.
 */
export function IngredientsEditor({ initialValue, onChange }: IngredientsEditorProps): JSX.Element {
  ...
  const update = (index: number, key: keyof Row, value: string): void =>
